...
def evaluation(status):
    ...
    os.system("/parsec-tests1/gem5_2/gem5/build/X86/gem5.fast -re --outdir=/m5out1 /parsec-tests1/gem5_2/gem5/configs/example/fs.py --script=/parsec-tests1/parsec-image/benchmark_src/blackscholes_{}c_simdev.rcS -F 5000000000  --cpu-type=TimingSimpleCPU --num-cpus={} --sys-clock='{}GHz' --caches --l2cache   --l1d_size='{}kB' --l1i_size='{}kB' --l2_size='{}kB' --l1d_assoc={} --l1i_assoc={} --l2_assoc={} --kernel=/parsec-tests1/parsec-image/system/binaries/x86_64-vmlinux-2.6.28.4-smp --disk-image=/parsec-tests1/parsec-image/system/disks/x86root-parsec.img".format(core,core,sys_clock,l1d_size,l1i_size,l2_size,l1d_assoc,l1i_assoc,l2_assoc))
    ...
    try:
        ...
        if os.path.exists("/m5out1/3.txt"):
            print("++++++++++++++++++++++++++startGEM5ToMcPAT+++++++++++++++++++++++++++++++++++++")
            command_2 = ["python3", "/parsec-tests1/cmcpat/cMcPAT/Scripts/GEM5ToMcPAT.py", \
                             "/m5out1/3.txt", "/m5out1/config.json", \
                             "/parsec-tests1/cmcpat/cMcPAT/mcpat/ProcessorDescriptionFiles/x86_AtomicSimpleCPU_template_core_{}.xml".format(
                                 core), "-o", "/parsec-tests1/cmcpat/cMcPAT/Scripts/test.xml"]
            process2 = Popen(command_2)
            process2.wait()
            print("++++++++++++++++++++++++++endGEM5ToMcPAT+++++++++++++++++++++++++++++++++++++")
            print("++++++++++++++++++++++++++startMcPAT+++++++++++++++++++++++++++++++++++++")

            file_output = open("/parsec-tests1/cmcpat/cMcPAT/mcpatresult/test2.log", "w")
            command_3 = ["/parsec-tests1/cmcpat/cMcPAT/mcpat/mcpat", "-infile", "/parsec-tests1/cmcpat/cMcPAT/Scripts/test.xml",
                             "-print_level", "5"]
            process3 = Popen(command_3, stdout=file_output)
            process3.wait()
            print("++++++++++++++++++++++++++endMcPAT+++++++++++++++++++++++++++++++++++++")
            print("++++++++++++++++++++++++++startprintenergy+++++++++++++++++++++++++++++++++++++")
                ...
                # process4.wait()
            metrics=getevaluation("/parsec-tests1/cmcpat/cMcPAT/mcpatresult/test2.log", "/m5out1/3.txt")
            print("++++++++++++++++++++++++++endprintenergy+++++++++++++++++++++++++++++++++++++")
            os.remove("/m5out1/3.txt")  if os.path.exists("/m5out1/3.txt") else None
            os.remove("/parsec-tests1/cmcpat/cMcPAT/mcpatresult/test2.log")  if os.path.exists("/parsec-tests1/cmcpat/cMcPAT/mcpatresult/test2.log") else None
            os.remove("/parsec-tests1/cmcpat/cMcPAT/Scripts/test.xml")  if os.path.exists("/parsec-tests1/cmcpat/cMcPAT/Scripts/test.xml") else None
            end = time.time()
