from crldse.env.space import dimension_discrete
from crldse.env.space import design_space
from crldse.env.space import create_space_gem5
from crldse.env.space import tsne3D
    ...
    def train(self):
        ...
        for period in range(period_bound):
            ...
            for step in range(self.DSE_action_space.get_lenth()):
                ...
                action, probs_noise = self.actor.action_choose_with_no_grad(
                ...
                if step < (
                    ...
                    if metrics != None:
                        ...
                        self.constraints.update(
                            {"LATENCY": runtime, "POWER": power, "AREA": area}
                        )
