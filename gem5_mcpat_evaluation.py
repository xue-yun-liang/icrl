...
def evaluation(status):
    ...
    try:
        ...
        if os.path.exists("/m5out/3.txt"):
            ...
            command_2 = ["python3", "/parsec-tests2/cmcpat/cMcPAT/Scripts/GEM5ToMcPAT.py", \
                             "/m5out/3.txt", "/m5out/config.json", \
                             "/parsec-tests2/cmcpat/cMcPAT/mcpat/ProcessorDescriptionFiles/x86_AtomicSimpleCPU_template_core_{}.xml".format(
                                 core), "-o", "/parsec-tests2/cmcpat/cMcPAT/Scripts/test.xml"]
            process2 = Popen(command_2)
            process2.wait()
            print("++++++++++++++++++++++++++endGEM5ToMcPAT+++++++++++++++++++++++++++++++++++++")
            print("++++++++++++++++++++++++++startMcPAT+++++++++++++++++++++++++++++++++++++")

            file_output = open("/parsec-tests2/cmcpat/cMcPAT/mcpatresult/test2.log", "w")
            command_3 = ["/parsec-tests2/cmcpat/cMcPAT/mcpat/mcpat", "-infile", "/parsec-tests2/cmcpat/cMcPAT/Scripts/test.xml",
                             "-print_level", "5"]
            ...
            print("++++++++++++++++++++++++++startprintenergy+++++++++++++++++++++++++++++++++++++")
                ...
                # process4.wait()
            metrics=getevaluation("/parsec-tests2/cmcpat/cMcPAT/mcpatresult/test2.log", "/m5out/3.txt")
            print("++++++++++++++++++++++++++endprintenergy+++++++++++++++++++++++++++++++++++++")
            os.remove("/m5out/3.txt")  if os.path.exists("/m5out/3.txt") else None
            os.remove("/parsec-tests2/cmcpat/cMcPAT/mcpatresult/test2.log")  if os.path.exists("/parsec-tests2/cmcpat/cMcPAT/mcpatresult/test2.log") else None
            os.remove("/parsec-tests2/cmcpat/cMcPAT/Scripts/test.xml")  if os.path.exists("/parsec-tests2/cmcpat/cMcPAT/Scripts/test.xml") else None
            end = time.time()
